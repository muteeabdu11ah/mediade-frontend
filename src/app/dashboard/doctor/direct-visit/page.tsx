...
import { useOnsiteConsultations, useCreateOnsiteConsultation, useDoctorOnsiteStats } from '@/hooks/use-onsite-consultations';
                            ...
                            <>
                                <Grid container spacing={3}>
                                    {onsiteConsultations.length === 0 ? (
                                        <Grid size={{ xs: 12 }}>
                                            <Typography textAlign="center" color="text.secondary" py={4}>No onsite consultations found for this day.</Typography>
                                        </Grid>
                                    ) : (
