...
const statCards = [
    ...
    { title: 'Active Doctors', value: '—', color: '#42A5F5', icon: <PeopleIcon /> },
    { title: 'Total Patients', value: '—', color: '#66BB6A', icon: <PeopleIcon /> },
];
            ...
            <DashboardLayout title="Admin Dashboard">
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }} key={card.title}>
                            <Card sx={{ bgcolor: 'white' }}>
                                <CardContent sx={{ p: 3 }}>
                                    ...
                                    <Typography variant="h4" fontWeight={800} sx={{ mb: 0.5, color: card.color }}>
                                        {card.value}
                                    </Typography>
                ...
                <Card sx={{ bgcolor: 'white', p: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                        Clinic management, user management, and analytics will be built here in Phase 3.
                    </Typography>
                </Card>
            </DashboardLayout>
        </ProtectedRoute>
