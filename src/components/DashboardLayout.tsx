...
export default function DashboardLayout({
  ...
  const drawerContent = (
    ...
    >
      ...
      <Box sx={{ p: 4, display: "flex", justifyContent: "center", mb: 1 }}>
        ...
        >
          <Image src="/logo2.svg" alt="Logo" width={170} height={60} />
        </Link>
      </Box>
      ...
      <Box
        sx={{
          ...
          bgcolor: COLORS.background.default + "40",
        }}
      >
  ...
  return (
    ...
    >
      ...
      <Box
        component="nav"
        sx={{ width: { md: DRAWER_WIDTH + 32 }, flexShrink: { md: 0 } }}
      >
        {isMobile ? (
          <Drawer
            variant="temporary"
      ...
      >
        <Box sx={{ mt: 3, mr: 3, ml: isMobile ? 3 : 0, mb: 0 }}>
          ...
          >
            <Toolbar sx={{ py: 1.5, px: 3 }}>
              ...
              <Typography
                variant="h4"
                sx={{ flex: 1, color: COLORS.text.primary }}
              >
                {title}
              </Typography>
        ...
        {/* Page Content */}
        <Box sx={{ flex: 1, p: 0, pt: 2, mr: 2, overflowY: "auto" }}>
          {children}
        </Box>
      </Box>
    </Box>
